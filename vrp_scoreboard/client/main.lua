...
function UpdatePlayerTable(connectedPlayers)
	...
	for k,v in pairs(connectedPlayers) do
		...
		if (v.job == 'EMS-Job' or v.job == 'Læge' or v.job == 'Regionschef') then
			ems = ems + 1
		elseif (v.job == 'Politi-Job' or v.job == 'Politibetjent' or v.job == 'Rigspolitichef') then
			police = police + 1
		elseif v.job == 'Taxi Chauffør' then
			taxi = taxi + 1
		elseif v.job == 'Mekaniker' then
			mechanic = mechanic + 1
		elseif (v.job == 'Bilforhandler') then
